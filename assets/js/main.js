...
const certifications = {
  ...
  cert3: {
    ...
    description:
      "Certificación de fundamentos de computación en la nube con AWS",
    image: "/assets/img/cert-aws.jpg",
    downloadLink: "/assets/certificates/aws-cert.pdf",
  },
  cert4: {
    title: "Frontend Developer",
    description: "Certificación completa en desarrollo Frontend",
    image: "/assets/img/cert-frontend.jpg",
    downloadLink: "/assets/certificates/frontend-cert.pdf",
  },
};
...
function openCertModal(certId) {
  ...
  if (cert) {
    ...
    document.getElementById("certModalDescription").textContent =
      cert.description;
    document.getElementById("certDownloadLink").href = cert.downloadLink;
